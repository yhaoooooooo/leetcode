...
class Solution071 {
    ...
    public String simplifyPath(String path) {
        ...
        for (String pathName : pathStack) {
            simplePath.append(pathName).append("/");
        }
        return simplePath.length() > 1 ? simplePath.deleteCharAt(simplePath.length() - 1).toString() : simplePath.toString();
    }
